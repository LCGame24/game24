  ...
  if (showModeSelect) return (
    <div style={{
      ...
      <div style={{textAlign:"center",marginBottom:32}}>
        ...
        }}><span>Game24<span style={{fontSize:"0.45em",verticalAlign:"super",color:"#fda085",fontWeight:400}}>&trade;</span></span></h1>
    ...
    return (
      <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#1a1a2e,#16213e,#0f3460)",
        ...
        <div ref={shareCardRef} style={{position:"fixed",left:"-9999px",top:0,width:380,
          ...
          <div style={{textAlign:"center",marginBottom:16}}>
            <div style={{fontSize:36,marginBottom:4}}>📅</div>
            <div style={{fontSize:26,fontWeight:900,color:"#f6d365"}}><span>Game24<span style={{fontSize:"0.45em",verticalAlign:"super",color:"#fda085",fontWeight:400}}>&trade;</span></span></div>
  ...
  return (
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#1a1a2e,#16213e,#0f3460)",
      ...
      <h1 style={{fontSize:30,fontWeight:900,margin:"0 0 2px",letterSpacing:-1,
        background:"linear-gradient(90deg,#f6d365,#fda085,#f6d365)",backgroundSize:"200%",
        WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",
        animation:"shimmer 3s linear infinite"}}><span>Game24<span style={{fontSize:"0.45em",verticalAlign:"super",color:"#fda085",fontWeight:400}}>&trade;</span></span></h1>
